...
def process_metadata(metadata, indir_path, geotiff_dir, sensor_dimensions):
    ...
    for data in metadata:
        try:
            ...
            properties = extract_sensor_info(data, sensor_dimensions, image.file_name)
    ...
    # Add lines to the GeoJSON feature collection if necessary
        ...
        mission_props = dict(date=image.datetime_original, Process_date=process_date, epsg=config.epsg_code, cog=config.cog)
