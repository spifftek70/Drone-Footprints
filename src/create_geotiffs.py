...
def create_gcp_list(coords, ext):
    ...
    gcp_string = '-gcp {} {} {} {} ' \
                 '-gcp {} {} {} {} ' \
                 '-gcp {} {} {} {} ' \
                 '-gcp {} {} {} {}'.format(ext0[0], ext0[1], pt2[0], pt2[1],
                                           ext1[0], ext1[1], pt3[0], pt3[1],
                                           ext2[0], ext2[1], pt0[0], pt0[1],
...
def warp_image_with_gcp(image_path, output_file, coord_array, yaw):
    """
    ...
    vrt_ds = gdal.Translate(output_file, ds, format='VRT', GCPs=gcp_list, outputSRS=wkt)
    # Define warp options
