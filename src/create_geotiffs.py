...
def warp_image_to_gcp(jpg_image_path, new_image_path, coordinate_array):
    ...
    gcp_list = [
        ...
        gdal.GCP(
            coordinate_array[1][0], coordinate_array[1][1], 0, src_ds.RasterXSize, 0
        ),  # Top Right
        gdal.GCP(
            coordinate_array[2][0],
            coordinate_array[2][1],
            0,
            src_ds.RasterXSize,
            src_ds.RasterYSize,
        ),
        # Bottom Right
        gdal.GCP(
            coordinate_array[3][0], coordinate_array[3][1], 0, 0, src_ds.RasterYSize
        ),  # Bottom Left
    ]
